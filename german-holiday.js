...
holidayCheck = function (date, state) {
    ...
    var holidayparams = [
        ...
        [new Date(easter.valueOf()).setDate(easter.getDate() - 2), [], "Karfreitag"],
        [easter, ["BB"], "Ostersonntag"],
        [new Date(easter.valueOf()).setDate(easter.getDate() + 1), [], "Ostermontag"],
        [new Date(date.getFullYear(), 4, 1), [], "Tag der Arbeit"],
        [new Date(easter.valueOf()).setDate(easter.getDate() + 39), [], "Christi Himmelfahrt"],
...
typeof exports !== 'undefined' ? exports.holidayCheck = holidayCheck : holidayCheck = holidayCheck
